...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*BGPControlPlane)(nil), (*cilium.BGPControlPlane)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BGPControlPlane_To_cilium_BGPControlPlane(a.(*BGPControlPlane), b.(*cilium.BGPControlPlane), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*cilium.BGPControlPlane)(nil), (*BGPControlPlane)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_cilium_BGPControlPlane_To_v1alpha1_BGPControlPlane(a.(*cilium.BGPControlPlane), b.(*BGPControlPlane), scope)
	}); err != nil {
		return err
	}
...
func Convert_v1alpha1_BGPControlPlane_To_cilium_BGPControlPlane(in *BGPControlPlane, out *cilium.BGPControlPlane, s conversion.Scope) error {
	return autoConvert_v1alpha1_BGPControlPlane_To_cilium_BGPControlPlane(in, out, s)
}
...
func Convert_cilium_BGPControlPlane_To_v1alpha1_BGPControlPlane(in *cilium.BGPControlPlane, out *BGPControlPlane, s conversion.Scope) error {
	return autoConvert_cilium_BGPControlPlane_To_v1alpha1_BGPControlPlane(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_cilium_NetworkConfig(in *NetworkConfig, out *cilium.NetworkConfig, s conversion.Scope) error {
	...
	out.IPv4 = (*cilium.IPv4)(unsafe.Pointer(in.IPv4))
	...
	out.DirectRoutingDevice = (*string)(unsafe.Pointer(in.DirectRoutingDevice))
	...
	out.IPv6NativeRoutingCIDREnabled = (*bool)(unsafe.Pointer(in.IPv6NativeRoutingCIDREnabled))
